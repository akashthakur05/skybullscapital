...
const HomeSingleSlide = ({ slider_class,content_class, attr_1, attr_2, attr_3 = "Work with a Konsul advisor to plan for your future.",btn_text}) => {
   return (
      <>
...
export default HomeSingleSlide;